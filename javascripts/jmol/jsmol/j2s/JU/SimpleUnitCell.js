...
function (params) {
return (JU.SimpleUnitCell.approx0 (params[0] - params[1]) && params[3] == 90 && params[4] == 90 && (params[5] == 120 || params[5] == -1));
}, "~A");
c$.isRhombohedral = Clazz.defineMethod (c$, "isRhombohedral", 
function (params) {
return (JU.SimpleUnitCell.approx0 (params[0] - params[1]) && JU.SimpleUnitCell.approx0 (params[1] - params[2]) && params[3] != 90 && JU.SimpleUnitCell.approx0 (params[3] - params[4]) && JU.SimpleUnitCell.approx0 (params[4] - params[5]));
}, "~A");
