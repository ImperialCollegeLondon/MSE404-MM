...
Clazz.load (["javajs.api.JSONEncodable", "JS.T", "java.lang.Float", "JU.P3"], "JS.SV", ["java.lang.Boolean", "java.util.Arrays", "$.Collections", "$.Hashtable", "JU.AU", "$.BArray", "$.BS", "$.Base64", "$.Lst", "$.Measure", "$.PT", "$.SB", "JM.BondSet", "JU.BSUtil", "$.Escape", "JV.Viewer"], function () {
