...
;//5.0.1-v2 Sat Nov 25 17:51:22 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["J.api.SmilesMatcherInterface"], "JS.SmilesMatcher", ["java.lang.Boolean", "JU.AU", "$.BS", "$.PT", "JS.InvalidSmilesException", "$.SmilesAtom", "$.SmilesBond", "$.SmilesGenerator", "$.SmilesParser", "$.SmilesSearch", "JU.BSUtil", "$.Elements", "$.Logger"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.okMF = true;
Clazz_instantialize (this, arguments);
...
var c$ = Clazz_declareType (JS, "SmilesAromatic");
