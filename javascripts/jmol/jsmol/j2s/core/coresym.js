...
if (this.acr.noPack ? !this.removePacking (this.ndims, pt0, minXYZ2.x, maxXYZ2.x, minXYZ2.y, maxXYZ2.y, minXYZ2.z, maxXYZ2.z, this.packingError) : !this.isWithinCell (this.ndims, pt0, minXYZ2.x, maxXYZ2.x, minXYZ2.y, maxXYZ2.y, minXYZ2.z, maxXYZ2.z, this.packingError)) bsAtoms.clear (i);
}
return;
}var offset = null;
this.nVib = 0;
...
;//5.0.1-v2 Sat Nov 25 18:21:56 CST 2023
...
;//5.0.1-v2 Sat Nov 25 18:21:55 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["JU.M3", "$.V3"], "JS.PointGroup", ["java.lang.Float", "java.util.Hashtable", "JU.Lst", "$.P3", "$.PT", "$.Quat", "$.SB", "J.bspt.Bspt", "JU.BSUtil", "$.Escape", "$.Logger", "$.Point3fi"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.isAtoms = false;
this.drawInfo = null;
this.info = null;
...
;//5.0.1-v2 Sat Nov 25 18:14:25 CST 2023
Clazz_declarePackage ("JS");
...
;//5.0.1-v2 Sat Nov 25 18:13:28 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["JU.P3", "$.V3"], "JS.SymmetryDesc", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.BS", "$.Lst", "$.M4", "$.Measure", "$.P4", "$.PT", "$.Quat", "$.SB", "JS.T", "JS.SpaceGroup", "$.Symmetry", "$.SymmetryOperation", "JU.Escape", "$.Logger"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.modelSet = null;
Clazz_instantialize (this, arguments);
}, JS, "SymmetryDesc");
...
;//5.0.1-v2 Sat Nov 25 18:21:56 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["JU.SimpleUnitCell", "JU.P3", "JV.JC"], "JS.UnitCell", ["java.lang.Double", "$.Float", "java.util.Hashtable", "JU.Lst", "$.M3", "$.M4", "$.P4", "$.PT", "$.Quat", "$.V3", "J.api.Interface", "JS.Symmetry", "JU.BoxInfo", "$.Escape"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.vertices = null;
