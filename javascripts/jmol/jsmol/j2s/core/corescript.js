...
;//5.0.1-v2 Sat Nov 25 17:51:22 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["JS.ScriptTokenParser", "JU.Lst"], "JS.ScriptCompiler", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.AU", "$.BS", "$.PT", "$.SB", "J.api.Interface", "J.i18n.GT", "JM.BondSet", "$.Group", "JS.ContextToken", "$.SV", "$.ScriptContext", "$.ScriptError", "$.ScriptFlowContext", "$.ScriptFunction", "$.ScriptManager", "$.T", "JU.Edge", "$.Escape", "$.Logger", "JV.FileManager", "$.Viewer"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.filename = null;
this.isSilent = false;
...
;//5.0.1-v2 Sat Nov 25 17:51:22 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["JS.ScriptParam"], "JS.ScriptExpr", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.BS", "$.CU", "$.Lst", "$.Measure", "$.P3", "$.PT", "$.SB", "J.api.Interface", "JM.AtomCollection", "$.BondSet", "$.Group", "$.ModelSet", "JS.SV", "$.ScriptMathProcessor", "$.T", "JU.BSUtil", "$.Edge", "$.Elements", "$.Escape"], function () {
var c$ = Clazz_decorateAsClass (function () {
...
;//5.0.1-v2 Sat Nov 25 17:51:22 CST 2023
Clazz_declarePackage ("JS");
Clazz_load (["J.api.JmolScriptManager", "JU.Lst"], "JS.ScriptManager", ["java.lang.Boolean", "$.Thread", "java.util.Hashtable", "JU.AU", "$.PT", "$.Rdr", "$.SB", "J.api.Interface", "J.i18n.GT", "JS.ScriptQueueThread", "JU.Elements", "$.Logger", "JV.FileManager"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.vwr = null;
this.eval = null;
this.evalTemp = null;
