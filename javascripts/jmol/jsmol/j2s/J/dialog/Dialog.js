...
}, J.dialog, "Dialog", javax.swing.JPanel, J.api.JmolDialogInterface);
...
this.slider = null;
Clazz.instantialize (this, arguments);
}, J.dialog.Dialog, "QualityListener", null, javax.swing.event.ChangeListener);
Clazz.makeConstructor (c$, 
...
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
}, J.dialog.Dialog, "ExportChoiceListener", null, java.awt.event.ItemListener);
...
this.thisType = null;
Clazz.instantialize (this, arguments);
}, J.dialog.Dialog, "TypeFilter", javax.swing.filechooser.FileFilter);
Clazz.makeConstructor (c$, 
function (type) {
...
c$.isMac = c$.prototype.isMac = System.getProperty ("os.name", "").startsWith ("Mac");
});
