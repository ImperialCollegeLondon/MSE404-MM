...
Clazz.load (["JU.BS", "$.P3", "J.i18n.GT"], "J.modelkit.ModelKit", ["java.lang.Boolean", "$.Double", "$.Float", "$.IllegalArgumentException", "java.util.Arrays", "$.Hashtable", "JU.Lst", "$.Measure", "$.PT", "$.Quat", "$.SB", "$.V3", "JM.AtomCollection", "$.ModelSet", "JS.SV", "JU.BSUtil", "$.Edge", "$.Elements", "$.Escape", "$.Logger", "$.SimpleUnitCell", "JV.Viewer"], function () {
...
var basis;
var sg = null;
var sgInfo = (noAtoms && !isDefined ? null : this.vwr.findSpaceGroup (isDefined ? null : bsAtoms, isDefined ? (isITA ? "ITA/" + name : name) : null, sym.getUnitCellParams (), false, true));
if (sgInfo == null) {
name = "P1";
