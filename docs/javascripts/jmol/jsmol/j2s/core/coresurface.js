...
var c$ = Clazz_declareType (JU, "TriangleData");
Clazz_defineStatics (c$,
...
var c$ = Clazz_declareType (J.jvxl.data, "JvxlCoder");
...
;//5.0.1-v2 Sat Nov 25 17:51:22 CST 2023
Clazz_declarePackage ("J.jvxl.readers");
Clazz_load (["JU.P3", "$.V3"], "J.jvxl.readers.SurfaceGenerator", ["java.lang.Float", "JU.AU", "$.BS", "$.Measure", "$.P4", "$.PT", "$.Rdr", "$.SB", "J.jvxl.data.JvxlCoder", "$.JvxlData", "$.MeshData", "$.VolumeData", "J.jvxl.readers.Parameters", "$.SurfaceReader", "JU.Logger", "JV.FileManager"], function () {
var c$ = Clazz_decorateAsClass (function () {
this.params = null;
this.jvxlData = null;
this.meshData = null;
